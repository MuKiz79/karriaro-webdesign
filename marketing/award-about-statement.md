# Karriaro Webdesign — About-Statement (Award-Submission)

## Kurz (≈80 Wörter, für Awwwards / CSSDA)

Karriaro ist eine deutsche Webdesign-Manufaktur, die lokalen Unternehmen handcodierte Websites mit branchen-spezifischen Live-Tools liefert — BFSG-konform, Festpreis, ohne Abo. Die Brand-Site ist ihre eigene Case-Study: 50+ interaktive Werkzeuge auf 7 Demo-Branchen, Live-Performance-Counter, custom Editorial-Type-System (Fraunces · Inter · JetBrains Mono · Cormorant Garamond), und ein 4-Tier-Pricing-Modell mit Branchen-Selector. Geschrieben in Vanilla HTML/CSS/JS — 10.538 Zeilen handcodierter Code, kein Framework, kein Template, kein Plugin.
...
10.538 Zeilen handcodierter Code · 0 Templates · 0 Plugins · 0 Subunternehmer. Vanilla HTML/CSS/JS auf GitHub Pages. Die Website ist ihre eigene Bewerbung.
