...
const MOBILE_OVERRIDES_LINK = `    <link rel="stylesheet" href="/css/mobile-overrides.css?v=203">
...
const M_INTERACTIONS_SCRIPT = `\n<script src="/js/m-interactions.js?v=203" defer></script>\n`;
...
.hero-headline{font-family:'Inter',-apple-system,sans-serif;font-size:44px;font-weight:700;line-height:1.05;letter-spacing:-0.025em;margin:0 18px 24px;color:#0A0A0B}
