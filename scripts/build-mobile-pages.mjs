...
const MOBILE_OVERRIDES_LINK = `    <link rel="stylesheet" href="/css/mobile-overrides.css?v=204">
...
const M_INTERACTIONS_SCRIPT = `\n<script src="/js/m-interactions.js?v=204" defer></script>\n`;
...
body{margin:0;font-family:'Inter',-apple-system,BlinkMacSystemFont,'SF Pro Text',system-ui,sans-serif;background:#FAFAF9;color:#0A0A0B;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}
main{display:block}
nav{position:fixed;top:0;left:0;right:0;z-index:60;background:rgba(250,250,249,0.92);-webkit-backdrop-filter:saturate(180%) blur(20px);backdrop-filter:saturate(180%) blur(20px);height:64px;display:flex;align-items:center;border-bottom:1px solid rgba(0,0,0,0.04)}
.hero-with-photo{padding:56px 0 32px;min-height:100svh;background:#FAFAF9}
.hero-inner{max-width:560px;margin:0 auto}
.hero-folio-eyebrow{font-family:'Inter',-apple-system,sans-serif;font-size:13px;letter-spacing:0.08em;text-transform:uppercase;color:#52525B;margin:0 18px 20px;font-weight:600;line-height:1.2}
.hero-headline{font-family:'Inter',-apple-system,sans-serif;font-size:52px;font-weight:700;line-height:1.05;letter-spacing:-0.025em;margin:0 18px 24px;color:#0A0A0B}
.hero-headline .hero-h1-line{display:block}
section h2{font-family:'Inter',-apple-system,sans-serif;font-size:32px;font-weight:700;line-height:1.1;letter-spacing:-0.02em;color:#0A0A0B}
