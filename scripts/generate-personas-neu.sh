...
weg-a|weg/haus-a.jpg|3:2|19920307|Photorealistic architectural photograph of the entrance of a well-kept modern German multi-family apartment building in Bremen, clean light rendered facade with dark anthracite window frames, a neat row of stainless steel letterboxes beside the glass entrance door, a low clipped hedge and a swept paved path, two bicycles parked in an orderly rack at the frame edge. Everything visibly maintained: no graffiti, no flyers, no weeds. Lighting: soft overcast northern daylight, gentle even shadows, real material texture in the render and metal.${ANTI_AI_OBJEKT}
weg-b|weg/haus-b.jpg|3:2|19860519|Photorealistic architectural photograph of an inner courtyard of a maintained German apartment complex, red brick facade with white balcony fronts, mown lawn strip, tidy bin enclosure with a wooden screen, a mature birch tree casting light shadow. Sense of order and care rather than luxury. Lighting: late morning sun from camera left, soft contrast, real brick and render texture.${ANTI_AI_OBJEKT}
bestatter-a|bestatter/persona-a.jpg|4:5|19731121|Editorial photorealistic portrait of Andreas, a calm and dignified German funeral director man in his early fifties, with attentive grey-blue eyes and an unhurried composed expression, a lined weathered face with genuine character, short greying hair combed back, clean-shaven, fair skin with visible texture. Wearing a plain dark charcoal suit with a white shirt, no tie, no jewelry, hands relaxed. Setting: standing in the quiet reception room of a family funeral home, warm oak panelling and a simple white lily arrangement softly out of focus behind him, a tall window with sheer linen curtain. Lighting: soft diffuse daylight, low contrast, subdued warm tones. Mood: someone who does not hurry you, third generation, quiet respect — no staged sorrow, no theatrical solemnity.${ANTI_AI}
bestatter-b|bestatter/persona-b.jpg|4:5|19690804|Editorial photorealistic portrait of Andreas, a composed German funeral director man in his late fifties, with calm dark eyes, deep laugh lines, neatly trimmed grey beard, thinning grey hair, fair skin with real texture, an expression of steady attentiveness. Wearing a dark grey wool suit over a white shirt with the collar open. Setting: seated at a plain oak table in the consultation room of a family funeral home, a simple candle and a folder in soft bokeh, muted olive wall behind. Lighting: warm side light from a window camera right, gentle falloff, restrained palette. Mood: patient, grounded, present without pressure.${ANTI_AI}
fitness-a|fitness/halle-a.jpg|3:2|19980612|Photorealistic interior photograph of an independent strength training gym inside a converted early twentieth century factory hall in Leipzig, exposed red brick walls and tall industrial steel windows, high ceiling with visible riveted beams, a row of black power racks with loaded barbells on rubber flooring, chalk bowl on a stand, weight plates neatly returned to their trees. Empty of people. Sense of a serious well-kept training hall, not a chrome fitness chain. Lighting: cool daylight flooding through the tall windows from camera left, long soft shadows across the floor.${ANTI_AI_OBJEKT}
fitness-b|fitness/halle-b.jpg|3:2|19910928|Photorealistic interior photograph of a spacious independent gym in a converted industrial hall, polished concrete floor, dark grey painted brick, a long dumbbell rack in perfect order along the wall, two flat benches, a rowing machine at the frame edge, tall factory windows with steel muntins. No people, no logos, no signage. Warm pendant lamps overhead mixed with daylight. Mood: disciplined and clean, spacious, the opposite of a crowded discount studio.${ANTI_AI_OBJEKT}
EOF
