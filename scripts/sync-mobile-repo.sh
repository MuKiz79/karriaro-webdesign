...
echo "→ Pfad-Rewrite: /images/ → https://karriaro-webdesign.de/images/ (quote-basiert)"
# QUOTE-BASIERT (statt attribut-spezifisch): deckt src=/href=/srcset=/poster=/
# CSS url('…')/url("…") + JS-String-Refs ('…','…') ab. Vorher blieben poster=,
# url() und JS-Mockup-Strings relativ → 47 Konsolen-404 auf m-Host (Award-Blocker).
# Geprüft: keine unquoted url(/images/) und keine komma-srcset in src/m → 2 Regeln genügen.
