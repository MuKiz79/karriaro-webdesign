...
# A real KANTE iteration: commit 73993a5 asked only for the project area;
# ca22967 added material, goal and a more useful project summary. The former
# hero image contained a person and is deliberately not republished here.
kante_atelier = '''<details class="atelier-peek" id="atelierblick-kante">
  <summary class="wrap"><span class="atelier-summary-index">KANTE / Atelierblick</span><strong>Eine Entscheidung sichtbar machen.</strong><span class="atelier-summary-icon" aria-hidden="true">+</span></summary>
  <div class="wrap atelier-body">
    <div class="atelier-heading"><div><p class="eyebrow">Aus dem Projektverlauf · 23.09.2026</p><h3>Vom ersten Feld<br>zur <em>Projektskizze.</em></h3></div><p>Ein echter Schritt in der Entwicklung von KANTE: Zuerst ließ sich nur ein Projektbereich wählen. Später kamen Material und gewünschte Wirkung hinzu. Die Beispiele unten zeigen diese beiden belegten Stände in einer kompakten Darstellung.</p></div>
    <div class="atelier-comparison" aria-label="Vergleich von frühem und aktuellem KANTE-Projektweg">
      <figure class="atelier-state atelier-state--early"><div class="atelier-state-top"><span>01 / Früher Stand</span><span>Nur der Bereich</span></div><div class="atelier-state-copy"><h4>Erzählen Sie uns,<br><em>wo es beginnt.</em></h4><p>Wählen Sie ein Thema. Die Skizze zeigt, welche Fragen ein echtes Projektgespräch vorbereiten würde.</p></div><div class="atelier-mini-panel"><span>WAS HABEN SIE VOR?</span><div class="atelier-mini-choices"><i>01&nbsp; Fenster</i><i>02&nbsp; Fassade</i><i>03&nbsp; Innenraum</i></div><div class="atelier-mini-result"><span>IHRE SKIZZE</span><p>Wählen Sie einen Bereich. Hier erscheint der passende nächste Schritt.</p></div></div><figcaption>Die erste Fassung bot eine Auswahl, blieb für das Vorhaben aber noch allgemein.</figcaption></figure>
      <figure class="atelier-state atelier-state--current"><div class="atelier-state-top"><span>02 / Weiterentwickelt</span><span>Bereich · Material · Ziel</span></div><div class="atelier-state-copy"><h4>Aus einer Idee<br>wird ein <em>Plan.</em></h4><p>Was soll entstehen? Welches Material passt? Und was soll der Raum künftig besser können?</p></div><div class="atelier-mini-panel"><span>01 / WAS HABEN SIE VOR?</span><div class="atelier-mini-row"><b>Fenster</b><small>Fassade · Innenraum</small></div><span>02 / WELCHES MATERIAL?</span><div class="atelier-mini-row atelier-mini-swatches"><b>Bronze</b><small>Holz · Stahl</small></div><span>03 / WAS IST IHNEN WICHTIG?</span><div class="atelier-mini-row"><b>Mehr Licht</b><small>Ruhe · Bestand</small></div><div class="atelier-mini-result"><span>IHRE PROJEKTSKIZZE</span><p>Bereich, Material und Ziel bilden eine konkretere Grundlage für das Gespräch.</p></div></div><figcaption>Die aktuelle Fassung führt durch drei Entscheidungen und lässt sich auf der Website ausprobieren.</figcaption></figure>
    </div>
    <div class="atelier-end"><p>Auf Basis der archivierten und aktuellen Projektstände kompakt nachgesetzt. KANTE ist ein fiktiver Betrieb; die Projektskizze ist eine Demo.</p><a href="/studien/kante.html#projekt">Aktuellen Projektweg ausprobieren <span aria-hidden="true">↗</span></a></div>
  </div>
</details>'''
...
intro = '<section class="page-hero gallery-hero wrap"><p class="eyebrow">Karriaro / Werkschau</p><h1>Jede Aufgabe<br><em>eine eigene Welt.</em></h1><p>Drei bedienbare Website-Konzepte zeigen, wie unterschiedlich Gestaltung und Funktion sein können. Dazu kommt mein veröffentlichter persönlicher Auftritt.</p><nav class="gallery-jump" aria-label="Bereiche der Werkschau"><a href="#konzepte">Konzepte ausprobieren ↘</a><a href="#atelierblick-kante">Atelierblick KANTE ↘</a><a href="#veroeffentlicht">Veröffentlichte Website ↘</a></nav></section>'
...
for index, slug in enumerate(featured_slugs, start=1):
    ...
    if slug == 'kante': gallery += kante_atelier
gallery += '</section>'
gallery += published
...
gallery_page = gallery_page.replace('</head>', '<link rel="stylesheet" href="/assets/gallery.css?v=20260923d"><link rel="stylesheet" href="/assets/atelier.css"><script src="/assets/atelier.js" defer></script></head>')
