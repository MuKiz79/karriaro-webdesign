...
published = '<section class="published-work wrap" id="veroeffentlicht" aria-labelledby="published-title"><a href="https://muammerkizilaslan.com/" aria-label="Veröffentlichte Website von Muammer Kizilaslan öffnen"><img src="/assets/projects/muammerkizilaslan-desktop-poster.webp" width="1920" height="862" alt="Die veröffentlichte persönliche Website von Muammer Kizilaslan mit ihrem Themen-Netz"></a><div><span class="work-type">01 / Eigene Website · veröffentlicht</span><h2 id="published-title">Kein Lebenslauf.<br>Eine Denkweise.</h2><p>Meine persönliche Website verbindet Themen als bewegliches Netz, statt Stationen aufzuzählen. Konzept, Gestaltung und Umsetzung aus einer Hand – live unter muammerkizilaslan.com.</p><a class="text-link" href="https://muammerkizilaslan.com/">Veröffentlichte Website öffnen <span class="brand-cue" aria-hidden="true">↗</span></a><a class="gallery-case-link" href="/einblick-muammer.html">Vom Material zur Designentscheidung</a></div></section>'
