...
(SITE / 'einblick-kante.html').write_text(page('KANTE – Einblick in die Gestaltung', 'Einblick in die Designentscheidungen hinter KANTE: Bildsprache, Raster und interaktive Projektskizze eines Website-Konzepts.', 'einblick-kante', kante_case))
